...
var statuses = [`.gg/mcfaontop`]; //Bot Status
var timers = 2;
const owners = ["1099362668734861312","1188435239077421108"]; //Bot  owners
client.login('Your Token Here');//bot token here
client.on("ready", () => {
...
client.on("message", message => {
  if (message.content.toLowerCase().startsWith(prefix + "help".toLowerCase())) {
    ...
    let help = new Discord.MessageEmbed()
      ...
      .setFooter(`Developed by GW HATTORI
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "setavatar")) {
    ...
    message.channel.send(`Bots profile picture  changing ...`).then(me => {
      me.edit(` Done!`);
    });
  }
});
